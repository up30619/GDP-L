...
unsigned char pchMessageStart[4] = { 0xaf, 0xd5, 0x5d, 0xa4};
int64 nChainStartTime = 1532679312;
...
const string strMessageMagic = "GDP-L Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in GDP-L
    bool fStrictPayToScriptHash = true; // Always active in GDP-L
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GDP-L", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "GDP-L,2018.7.27!GDP-L,2018.7.27GDP-L,2018.7.27";
        CTransaction txNew;
      ...
      if (true  && (block.GetHash() != hashGenesisBlock))
        ...
        assert(block.hashMerkleRoot == uint256("0x3a5fc18203a5666096e461c823edb65ed3c9dead21a80c724dfd970d6970d74e"));
